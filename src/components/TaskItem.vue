  ...
  <div class="flex flex-col-reverse lg:flex-row items-center mx-6 relative">
    <label class="flex items-start lg:items-center justify-start w-full mb-4 pr-6 lg:mb-0 lg:w-9/12">
      <input
        ...
        class="form-checkbox mt-1 mr-4 lg:mt-0  cursor-pointer appearance-none bg-white bg-check h-5 w-5 min-w-5 border border-gray-300 rounded-md checked:bg-purple-500 checked:border-transparent focus:outline-none focus:ring-transparent"
      />
