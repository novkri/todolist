<template>
  <li class="flex items-center justify-between py-3 border-b-2 border-gray-100 cursor-pointer" :class="[task.done ? 'text-gray-400' : 'text-gray-600']">
    ...
    <svg v-if="!task.done" width="20" height="20" fill="currentColor" class="mx-4 text-gray-400" viewBox="0 0 1024 1024">
    ...
    <svg v-else width="20" height="20" fill="currentColor" viewBox="0 0 1024 1024" class="text-green-500 mx-4">
